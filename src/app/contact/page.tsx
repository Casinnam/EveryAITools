...
export default function ContactPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      <p className="mt-3 text-base font-semibold leading-8 text-slate-600 dark:text-slate-300">
        한국어로도 문의하실 수 있습니다. AI 도구 정보 수정, 개인정보 요청, 제휴 문의, 사이트 피드백을 보내주세요.
      </p>
      ...
      <div className="mt-14 border-t border-slate-200 pt-10 dark:border-slate-800">
        ...
        <h2 className="mt-3 text-3xl font-black tracking-normal text-slate-950 dark:text-white">문의하기</h2>
        <p className="mt-5 text-base font-medium leading-8 text-slate-600 dark:text-slate-300">
          Every AI Finder에 한국어로 문의하실 수 있습니다. 가능한 경우 관련 도구 이름, 페이지 URL, 공식 출처 링크를 함께 보내주시면
          더 빠르게 확인할 수 있습니다.
        </p>

        <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <h3 className="text-xl font-black text-slate-950 dark:text-white">이메일</h3>
          <p className="mt-3 text-base leading-8 text-slate-700 dark:text-slate-300">
            문의는{' '}
            <a className="font-bold text-indigo-600 hover:text-indigo-700" href="mailto:contact@everyaifinder.com">
              contact@everyaifinder.com
        ...
        <div className="mt-8 space-y-5 text-base leading-8 text-slate-700 dark:text-slate-300">
          <section>
            <h3 className="text-xl font-black text-slate-950 dark:text-white">수정 요청</h3>
            <p className="mt-3">
          ...
          <section>
            <h3 className="text-xl font-black text-slate-950 dark:text-white">개인정보 요청</h3>
            <p className="mt-3">
          ...
          <section>
            <h3 className="text-xl font-black text-slate-950 dark:text-white">제휴 및 피드백</h3>
            <p className="mt-3">
