  ...
  if (language === 'ko') {
    return (
      <article className="mx-auto max-w-3xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-normal text-slate-950 dark:text-white">개인정보처리방침</h1>
        ...
        <div className="mt-10 space-y-8 text-base leading-8 text-slate-700 dark:text-slate-300">
          <section>
            <h2 className="text-xl font-black text-slate-950 dark:text-white">수집하는 정보</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950 dark:text-white">이용 목적</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950 dark:text-white">쿠키, 분석 및 광고</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950 dark:text-white">공유 및 보관</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950 dark:text-white">사용자 권리</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-black text-slate-950 dark:text-white">문의</h2>
            <p className="mt-3">
